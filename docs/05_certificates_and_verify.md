...
### 5.4 Size-Change Termination Certificate (`size_change_scc_v1.json`)
```json
{
  "schema_version": "size_change_scc_v1",
  "scc_id": "SCC-DEPTH20-CRITICAL-001",
  "feature_vector": ["v2_L1", "v2_L2", "bitlength", "growth_debt"],
  "transition_graphs": [
    {
      "edge": "(u1, v1)",
      "valuation_word": [1, 2],
      "relations": [["v2_L1", "decrease", "v2_L1"], ["v2_L2", "non_increase", "v2_L1"]]
    }
  ],
  "idempotent_closure_verified": true,
  "strict_descending_self_edges_proved": true
}
```
