...
pub use cocycle::{
    ...
    compute_word_affine_destination_pullback, compute_zero_lift_longest_path_bound,
    compose_cocycles, find_earliest_return_prefix, project_itinerary, project_symbol,
    verify_projected_canonical_admissibility, AbstractZeroLiftState, CensusManifest,
    CompiledSemanticReturn, ConcreteZeroLiftState, CumulativeAffineData,
    DestinationPullbackCylinder, DyadicExponent, DyadicWeight, ExactWordCylinder,
    FirstReturnSymbol, GapItinerary, GapSymbol, ItineraryPrefixCylinder, LiveItinerary,
    PrefixLiftDigit, PrefixRepresentativeStep, RejectionRecord, SemanticReturnCompilation,
